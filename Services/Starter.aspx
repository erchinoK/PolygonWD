<%@ Page Title="Starter Website" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Starter.aspx.cs" Inherits="Services_Starter" %>
    ...
    <div id="main-content-services">
        <div id="services-container" class="main-content">
            <div class="title">
                ...
                <p>The starter website is designed for a start-up company who is looking for something simple and affordable to begin with.</p>
            </div>                
            <div id="services-items">
                ...
                <div class="item">
                    <img alt="Fast and intuitive" src="../public/images/fast_and_intuitive.png" width="115px" height="125px" />
                    <h3>Fast and intuitive</h3>
                    <p>
                        The websites we create are developed to load quickly and be easy to use. All of it to provide you and your clients with the most enjoyable experience possible. 
                    </p>
                </div>
